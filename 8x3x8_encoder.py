...
''' The problem is I have 8 costs and the reason is that my initial activation function calculation is multiplying an (8,8) by an (8,3) giving me 8 scalar costs. '''
...
''' Execution with Training and Testing values. Using the first half of the 8x8 identity matrix as a training set and the second half as a testing set. '''
